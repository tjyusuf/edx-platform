...
class TestComponentTemplates(CourseTestCase):
    ...
    def test_create_support_level_flag_off(self):
        ...
        self._verify_advanced_xblocks(['Annotation', 'Survey'], ['fs', 'fs'])
    ...
    def test_xblock_masquerading_as_problem(self):
        ...
        verify_openassessment_present('fs')
    ...
    def _verify_basic_component(self, component_type, display_name, support_level='fs'):
        """
